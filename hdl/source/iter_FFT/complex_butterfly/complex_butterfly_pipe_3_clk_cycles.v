...
// Module Name: complex_butterfly_pipe_3_clk_cycles
...
//
// 	(2)			(mult_reg_2 - mult_reg_1 = re_reg)
//				(mult_reg_4 + mult_reg_3 = im_reg)
//												+		-
// 	(3)			(pre_sum_din3_re +- re_reg = dout1_re\dout2_re)
//				(pre_sum_din3_im +- im_reg = dout1_im\dout2_im) 
//
// -----!!!--ATTENTION--!!!-----
// Не рекомендуется ставить OWL => IWL1 + IWL2 - 1 
// Возможны ошибки в алгоритме!
// Операции суммы и вычитания во 2 такте работы модуля происходя без контроля переполнения!!
//
//-----------------------------------------------------------------\\
...
module complex_butterfly_pipe_3_clk_cycles #(
	...
	//-----------------------Сигналы умножителя----------------------\\
	wire	signed	[IWL2-1:0]			MUL_1_din1;
