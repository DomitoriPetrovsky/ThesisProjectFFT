...
// Module Name: complex_butterfly_iter_4_clk_cycles
// Project Name: ThesisProjectFFT
// Target Devices: Zeadboard
//
// Description: Данный блок операцию Бабочка за 4 периодов CLK.
// X =  A + W*B
// Y =  A - W*B
...
//																	+		-
// 	(4)		(3)3'b011		(pre_sum_din3_re +- pre_sum_re_reg = dout1_re\dout2_re)
...
module complex_butterfly_iter_4_clk_cycles #(
	...
	//-----------------------------------------------------------------\\
	assign SUB_1_din2_mux =	(pipe_cnt[1])? 	pre_sum_re_reg  :	mult_reg_2;
	assign SUB_1_din1_mux =	(pipe_cnt[1])? 	pre_sum_din3_re :	mult_reg_1;
